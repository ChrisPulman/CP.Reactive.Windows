...
public enum ProcessAccessRights : uint
{
    ...
    All = Terminate | CreateThread | SetSessionId | VirtualMemoryOperation | VirtualMemoryRead | VirtualMemoryWrite | DuplicateHandle | CreateProcess | SetQuota | SetInformation | QueryInformation | SuspendResume | QueryLimitedInformation | Delete | ReadControl | WriteDac | WriteOwner | Synchronize
}
