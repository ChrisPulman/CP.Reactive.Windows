...
public enum ShellGetFileInfoFlags
{
    ...
    /// <summary>Specifies no modifier flags. When combined with <see cref="F:CP.ReactiveUI.Primitives.Windows.Native.Shell.Enums.ShellGetFileInfoFlags.Icon" />, the shell returns a large icon.</summary>
    None = 0,
    /// <summary>
