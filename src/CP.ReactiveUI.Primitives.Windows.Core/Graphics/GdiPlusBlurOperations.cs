...
internal sealed class GdiPlusBlurOperations
{
    ...
    public GdiPlusApplyEffectOperation ApplyEffect { get; init; } = GdiPlusApi.NativeMethods.GdipBitmapApplyEffect;

    /// <summary>Gets the native effect creator.</summary>
    public GdiPlusCreateEffectOperation CreateEffect { get; init; } = GdiPlusApi.NativeMethods.GdipCreateEffect;

    /// <summary>Gets the native effect deleter.</summary>
    public GdiPlusDeleteEffectOperation DeleteEffect { get; init; } = GdiPlusApi.NativeMethods.GdipDeleteEffect;

    /// <summary>Gets the native effect drawing operation.</summary>
    public GdiPlusDrawImageFxOperation DrawImageFx { get; init; } = GdiPlusApi.NativeMethods.GdipDrawImageFX;
    ...
    public GdiPlusGetNativeHandleOperation GetNativeHandle { get; init; } = GdiPlusApi.GetNativeHandleForTesting;

    /// <summary>Gets the operating-system version reader.</summary>
    public Func<Version> GetOperatingSystemVersion { get; init; } = GdiPlusApi.GetOperatingSystemVersion;

    /// <summary>Gets the native effect-parameter setter.</summary>
    public GdiPlusSetEffectParametersOperation SetEffectParameters { get; init; } = GdiPlusApi.NativeMethods.GdipSetEffectParameters;

    /// <summary>Gets the blur-parameter writer.</summary>
    public GdiPlusStructureToPtrOperation StructureToPtr { get; init; } = GdiPlusApi.WriteBlurParameters;
