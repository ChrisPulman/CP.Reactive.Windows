...
public static class Advapi32Api
{
    ...
    private static Advapi32Operations _operations = new(NativeMethods.ConvertSidToStringSid, NativeMethods.RegNotifyChangeKeyValue, NativeMethods.RegOpenKeyEx, NativeMethods.GetTokenInformation);
    ...
    private static class NativeMethods
    {
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool GetTokenInformation(IntPtr tokenHandle, TokenInformationClasses tokenInformationClasses, IntPtr tokenInformation, int tokenInformationLength, out int returnLength);
        ...
        [DllImport("advapi32.dll", SetLastError = true)]
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        internal static extern int RegNotifyChangeKeyValue(SafeRegistryHandle key, [MarshalAs(UnmanagedType.Bool)] bool watchSubtree, RegistryNotifyFilter notifyFilter, SafeWaitHandle eventHandle, [MarshalAs(UnmanagedType.Bool)] bool asynchronous);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        internal static extern int RegOpenKeyEx(IntPtr parentKeyHandle, string subKey, RegistryOpenOptions options, RegistryKeySecurityAccessRights desiredAccess, out SafeRegistryHandle openedKey);
    }
    ...
    private sealed class Advapi32Operations(ConvertSidToStringSidOperation convertSidToStringSid, RegNotifyChangeKeyValueOperation regNotifyChangeKeyValue, RegOpenKeyOperation regOpenKey, GetTokenInformationOperation getTokenInformation)
    {
        ...
        public bool ConvertSidToStringSid(IntPtr sid, out IntPtr sidString) => convertSidToStringSid(sid, out sidString);
        ...
        /// <param name="asynchronous">Whether notification is asynchronous.</param>
        /// <returns>The configured operation result.</returns>
        public int RegNotifyChangeKeyValue(SafeRegistryHandle key, bool watchSubtree, RegistryNotifyFilter notifyFilter, SafeWaitHandle eventHandle, bool asynchronous) => regNotifyChangeKeyValue(key, watchSubtree, notifyFilter, eventHandle, asynchronous);
        ...
        /// <returns>The configured operation result.</returns>
        public int RegOpenKeyEx(IntPtr key, string subKey, RegistryOpenOptions options, RegistryKeySecurityAccessRights desiredAccess, out SafeRegistryHandle openedKey) => regOpenKey(key, subKey, options, desiredAccess, out openedKey);
        ...
        /// <returns>The configured operation result.</returns>
        public bool GetTokenInformation(IntPtr tokenHandle, TokenInformationClasses tokenInformationClasses, IntPtr tokenInformation, int tokenInformationLength, out int returnLength) => getTokenInformation(tokenHandle, tokenInformationClasses, tokenInformation, tokenInformationLength, out returnLength);
    }
    ...
    internal static bool ConvertSidToStringSid(IntPtr sid, out IntPtr sidString) => _operations.ConvertSidToStringSid(sid, out sidString);
    ...
    /// <returns>Win32 result code.</returns>
    internal static int RegNotifyChangeKeyValue(SafeRegistryHandle key, bool watchSubtree, RegistryNotifyFilter notifyFilter, SafeWaitHandle eventHandle, bool asynchronous) => _operations.RegNotifyChangeKeyValue(key, watchSubtree, notifyFilter, eventHandle, asynchronous);
    ...
    /// <returns>Win32 result code.</returns>
    internal static int RegOpenKeyEx(IntPtr key, string subKey, RegistryOpenOptions options, RegistryKeySecurityAccessRights desiredAccess, out SafeRegistryHandle openedKey) => _operations.RegOpenKeyEx(key, subKey, options, desiredAccess, out openedKey);
    ...
    internal static IDisposable OverrideOperationsForTesting(ConvertSidToStringSidOperation convertSidToStringSid, RegNotifyChangeKeyValueOperation regNotifyChangeKeyValue, RegOpenKeyOperation regOpenKey, GetTokenInformationOperation getTokenInformation)
    {
        ...
        _operations = new(convertSidToStringSid, regNotifyChangeKeyValue, regOpenKey, getTokenInformation);
        return Scope.Create(operations, delegate(Advapi32Operations previous)
        {
    ...
    internal static string GetCurrentSessionId(IntPtr token)
    {
        ...
        _ = GetTokenInformation(token, TokenInformationClasses.TokenGroups, IntPtr.Zero, tokenInfLength, out tokenInfLength);
        ...
        checked
        {
            try
            {
                ...
                {
                    SidAndAttributes sidAndAttributes = Marshal.PtrToStructure<SidAndAttributes>(IntPtr.Add(tokenInformation, IntPtr.Size + (i * sidAndAttrSize)));
                    if (sidAndAttributes.HasAttributes(3_221_225_472U))
                    {
    ...
    private static bool GetTokenInformation(IntPtr tokenHandle, TokenInformationClasses tokenInformationClasses, IntPtr tokenInformation, int tokenInformationLength, out int returnLength) => _operations.GetTokenInformation(tokenHandle, tokenInformationClasses, tokenInformation, tokenInformationLength, out returnLength);
}
