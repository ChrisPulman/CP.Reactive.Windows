...
#endif
/// <summary>Represents a captured cursor, including its color and mask layers, hot spot, and system cursor status.</summary>
...
{
    /// <summary>Gets or sets the color layer used for the ink.</summary>
    public Bitmap ColorLayer { get; set; }

    /// <summary>Gets or sets the mask layer used to determine cutout regions in the bitmap.</summary>
    ...
    /// <summary>Gets or sets the coordinates of the hotspot.</summary>
    ...
    /// <summary>Gets or sets the size of the native element.</summary>
    ...
    /// <summary>Creates a new CapturedCursor instance that is a copy of the current instance.</summary>
