...
{
    /// <summary>Don't know what class / GUID.</summary>
    Unknown,
    ...
    WriteOnceDisk,
    /// <summary>The GUID_DEVINTERFACE_USB_DEVICE interface class is defined for USB devices that are attached to a USB hub.</summary>
    ...
    SmartCard,
    /// <summary>SmartCard reader.</summary>
    [Description("50dd5230-ba8a-11d1-bf5d-0000f805f530")]
    SmartCardReader,
    /// <summary>SmartCard filter.</summary>
