...
public static class NativeCursorMethods
{
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern IntPtr LoadImage(IntPtr instanceHandle, IntPtr name, ImageType type, int cx, int cy, LoadImageFlags loadFlags);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        internal static extern IntPtr LoadImage(IntPtr instanceHandle, string name, ImageType type, int cx, int cy, LoadImageFlags loadFlags);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        internal static extern IntPtr CopyImage(IntPtr imageHandle, ImageType type, int cx, int cy, CopyImageFlags flags);
    }
    ...
    internal static IntPtr LoadImage(IntPtr instanceHandle, IntPtr name, ImageType type, int cx, int cy, LoadImageFlags loadFlags) => _api.LoadImage(instanceHandle, name, type, cx, cy, loadFlags);
    ...
    /// <param name="loadFlags">The load flags.</param>
    /// <returns>The loaded image handle.</returns>
    internal static IntPtr LoadImage(IntPtr instanceHandle, string name, ImageType type, int cx, int cy, LoadImageFlags loadFlags) => _api.LoadImage(instanceHandle, name, type, cx, cy, loadFlags);
    ...
    internal static IntPtr CopyImage(IntPtr imageHandle, ImageType type, int cx, int cy, CopyImageFlags flags) => _api.CopyImage(imageHandle, type, cx, cy, flags);
