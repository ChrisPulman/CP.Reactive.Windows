...
public static class NativeIconMethods
{
    ...
    internal readonly record struct DrawIconArguments
    {
        ...
        public DrawIconArguments(IntPtr deviceContext, (int Left, int Top) location, IntPtr iconHandle, (int Width, int Height) size, int animationStep, IntPtr flickerFreeBrush, DrawIconExFlags flags)
        {
        ...
        [CompilerGenerated]
        public override int GetHashCode() => (((((((((((((((EqualityComparer<IntPtr>.Default.GetHashCode(_deviceContext) * -1_521_134_295) + EqualityComparer<IntPtr>.Default.GetHashCode(_iconHandle)) * -1_521_134_295) + EqualityComparer<IntPtr>.Default.GetHashCode(_flickerFreeBrush)) * -1_521_134_295) + EqualityComparer<int>.Default.GetHashCode(Left)) * -1_521_134_295) + EqualityComparer<int>.Default.GetHashCode(Top)) * -1_521_134_295) + EqualityComparer<int>.Default.GetHashCode(Width)) * -1_521_134_295) + EqualityComparer<int>.Default.GetHashCode(Height)) * -1_521_134_295) + EqualityComparer<int>.Default.GetHashCode(AnimationStep)) * -1_521_134_295) + EqualityComparer<DrawIconExFlags>.Default.GetHashCode(Flags);

        [CompilerGenerated]
        public bool Equals(DrawIconArguments other)
        {
            if (EqualityComparer<IntPtr>.Default.Equals(_deviceContext, other._deviceContext) && EqualityComparer<IntPtr>.Default.Equals(_iconHandle, other._iconHandle) && EqualityComparer<IntPtr>.Default.Equals(_flickerFreeBrush, other._flickerFreeBrush) && EqualityComparer<int>.Default.Equals(Left, other.Left) && EqualityComparer<int>.Default.Equals(Top, other.Top) && EqualityComparer<int>.Default.Equals(Width, other.Width) && EqualityComparer<int>.Default.Equals(Height, other.Height) && EqualityComparer<int>.Default.Equals(AnimationStep, other.AnimationStep))
            {
                return EqualityComparer<DrawIconExFlags>.Default.Equals(Flags, other.Flags);
            }
    ...
    private readonly struct NativeIconResourceName
    {
        ...
        public int LoadMetric(IntPtr instanceHandle, IconMetricSize lims, out IntPtr iconHandle)
        {
            if (!_usesName)
            {
                return _api.LoadIconMetric(instanceHandle, _identifier, lims, out iconHandle);
            }

            return _api.LoadIconMetric(instanceHandle, _name, lims, out iconHandle);
        }
        ...
        public int LoadWithScaleDown(IntPtr instanceHandle, int cx, int cy, out IntPtr iconHandle)
        {
            if (!_usesName)
            {
                return _api.LoadIconWithScaleDown(instanceHandle, _identifier, cx, cy, out iconHandle);
            }

            return _api.LoadIconWithScaleDown(instanceHandle, _name, cx, cy, out iconHandle);
        }
    }
    ...
    internal static class NativeMethods
    {
        ...
        private static readonly IntPtr User32Module = System.Runtime.InteropServices.NativeLibrary.Load("user32.dll", typeof(NativeMethods).Assembly, DllImportSearchPath.System32);

        /// <summary>The GetIconInfoExW export pointer.</summary>
        private static readonly IntPtr GetIconInfoExExport = System.Runtime.InteropServices.NativeLibrary.GetExport(User32Module, "GetIconInfoExW");
        ...
        internal static unsafe bool GetIconInfoEx(IntPtr iconOrCursorHandle, ref IconInfoEx iconInfoEx)
        {
            ...
            {
                return ((delegate* unmanaged[Stdcall]<IntPtr, IconInfoEx*, int>)(void*)GetIconInfoExExport)(iconOrCursorHandle, iconInfoExPointer) != 0;
            }
        }
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool DrawIconEx(IntPtr deviceContext, int left, int top, IntPtr iconHandle, int width, int height, int animationStep, IntPtr flickerFreeBrush, DrawIconExFlags flags);
    }
    ...
    /// </returns>
    public static int LoadIconMetric(IntPtr instanceHandle, IntPtr iconName, IconMetricSize lims, out IntPtr iconHandle) => LoadIconMetric(instanceHandle, new NativeIconResourceName(iconName), lims, out iconHandle);
    ...
    /// If the function succeeds, it returns S_OK (0). Otherwise, it returns an HRESULT error code.
    /// </returns>
    public static int LoadIconMetric(IntPtr instanceHandle, string iconName, IconMetricSize lims, out IntPtr iconHandle) => LoadIconMetric(instanceHandle, new NativeIconResourceName(iconName), lims, out iconHandle);
    ...
    /// If the function succeeds, it returns S_OK (0). Otherwise, it returns an HRESULT error code.
    /// </returns>
    public static int LoadIconWithScaleDown(IntPtr instanceHandle, IntPtr iconName, int cx, int cy, out IntPtr iconHandle) => LoadIconWithScaleDown(instanceHandle, new NativeIconResourceName(iconName), cx, cy, out iconHandle);
    ...
    /// If the function succeeds, it returns S_OK (0). Otherwise, it returns an HRESULT error code.
    /// </returns>
    public static int LoadIconWithScaleDown(IntPtr instanceHandle, string iconName, int cx, int cy, out IntPtr iconHandle) => LoadIconWithScaleDown(instanceHandle, new NativeIconResourceName(iconName), cx, cy, out iconHandle);
    ...
    /// <param name="iconHandle">The loaded icon handle.</param>
    /// <returns>The HRESULT from the native loader.</returns>
    private static int LoadIconMetric(IntPtr instanceHandle, NativeIconResourceName iconName, IconMetricSize lims, out IntPtr iconHandle) => iconName.LoadMetric(instanceHandle, lims, out iconHandle);
    ...
    /// <param name="iconHandle">The loaded icon handle.</param>
    /// <returns>The HRESULT from the native loader.</returns>
    private static int LoadIconWithScaleDown(IntPtr instanceHandle, NativeIconResourceName iconName, int cx, int cy, out IntPtr iconHandle) => iconName.LoadWithScaleDown(instanceHandle, cx, cy, out iconHandle);
}
