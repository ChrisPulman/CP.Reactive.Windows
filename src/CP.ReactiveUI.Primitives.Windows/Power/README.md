# CP.ReactiveUI.Primitives.Windows.SystemState
...
Targets: `net462`, `net472`, `net48`, `net481`, `net10.0-windows`, `net11.0-windows`
...
```powershell
Install-Package CP.ReactiveUI.Primitives.Windows.SystemState
```
...
```csharp
using CP.ReactiveUI.Primitives.Windows.SystemState;
...
using CP.ReactiveUI.Primitives.Windows.SystemState.Enums;
...
> Available on every supported Windows target: `net462`, `net472`, `net48`, `net481`, `net10.0-windows`, and `net11.0-windows`.
...
var resumeSub = PowerBroadcastListener.SystemResumedFromSuspendEvents
    .Subscribe(_ =>
    {
...
```csharp
var autoResumeSub = PowerBroadcastListener.SystemAutomaticResumeEvents
    .Subscribe(_ =>
    {
...
var allEventsSub = PowerBroadcastListener.PowerBroadcastEvents
    .Subscribe(e =>
    {
        switch (e)
        {
