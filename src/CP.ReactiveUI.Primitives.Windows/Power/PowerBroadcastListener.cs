...
public static class PowerBroadcastListener
{
    ...
    public static IObservable<PowerBroadcastEvent> SystemSuspendingEvents => BroadcastEvents.Where((powerEvent) => powerEvent == PowerBroadcastEvent.PBT_APMSUSPEND);
    ...
    /// </summary>
    public static IObservable<PowerBroadcastEvent> SystemResumedFromSuspendEvents => BroadcastEvents.Where((powerEvent) => powerEvent == PowerBroadcastEvent.PBT_APMRESUMESUSPEND);
    ...
    /// </summary>
    public static IObservable<PowerBroadcastEvent> SystemAutomaticResumeEvents => BroadcastEvents.Where((powerEvent) => powerEvent == PowerBroadcastEvent.PBT_APMRESUMEAUTOMATIC);
    ...
    /// </summary>
    public static IObservable<PowerBroadcastEvent> PowerStatusChanges => BroadcastEvents.Where((powerEvent) => powerEvent == PowerBroadcastEvent.PBT_APMPOWERSTATUSCHANGE);
    ...
    {
        BroadcastEvents = (from message in SharedMessageWindow.WindowMessageEvents
